...
// slider
var Swiper_wrapper = /*#__PURE__*/function () {
  function Swiper_wrapper() {
    _classCallCheck(this, Swiper_wrapper);

    this.lib();
    this.sliders();
  }

  _createClass(Swiper_wrapper, [{
    key: "sliders",
    value: function sliders() {
      // slider steps
      var sliders = document.querySelectorAll('.main-reviews-slider');
      sliders.forEach(function (item) {
        ...
        new Swiper(item, {
          ...
          navigation: {
            nextEl: ".main-reviews-slider-navigation__button-prev",
            prevEl: ".main-reviews-slider-navigation__button-next"
          },
          // navigation: {
          // 	nextEl: `.${sliderProjectsClass}-navigation__button-prev`,
          // 	prevEl: `.${sliderProjectsClass}-navigation__button-next`,
          // },
          breakpoints: {
            200: {
              slidesPerView: 1
      ...
      var nameSlider = 'mane-slider';
      new Swiper(document.querySelector(".".concat(nameSlider)), {
        spaceBetween: 30,
        slidesPerView: 1,
        // кол-во слайдов
        slideToClickedSlide: true,
...
new Swiper_wrapper(); // tab

window.addEventListener("DOMContentLoaded", function () {
  document.addEventListener('click', function (e) {
    var element = e.target; // tab
    ...
    if (element.closest('.tab__link')) {
      ...
      var tabs = function tabs(element) {
        if (element.dataset.tab) {
          ...
          var parentTabs = element.closest('.cities-item'); // отбираем tab__link-container

          var tabLinkActiv = parentTabs.querySelector('.tab__link--active'); // отбираем tab__link--active
          // let tabContentActiv = document.querySelector('*[data-contentTab="'+tabLinkActiv.dataset.tab+'"]') // отбираем активный tab__content

          var tabContentActiv = parentTabs.querySelector('*[data-contentTab="' + tabLinkActiv.dataset.tab + '"]'); // отбираем активный tab__content

          console.log(tabContentActiv); // удаляем активные классы
          ...
          var tabContent = parentTabs.querySelector('*[data-contentTab="' + element.dataset.tab + '"]'); // отбираем активный tab__content

          tabContent.classList.add('tab__content-item--active'); // добовляем активный класс ссылке
        } else {
          // отбираем tab контейнер
          var _parentTabs = element.closest('.tab'); // отбираем и очищаем активный tab__link--active


          var _tabLinkActiv = _parentTabs.querySelector('.tab__link--active');

          _tabLinkActiv.classList.remove('tab__link--active'); // очищаем активный таб контент


          var _tabContentActiv = _parentTabs.querySelector('.tab__content-item--active');

          _tabContentActiv.classList.remove('tab__content-item--active'); // ccылка по которой кликнули


          var tabLink = element.closest('.tab__link');
          tabLink.classList.add('tab__link--active');

          var $tabLinks = _parentTabs.querySelectorAll('.tab__link');

          var $tabsContents = _parentTabs.querySelectorAll('.tab__content-item');

          $tabLinks.forEach(function (item, key) {
            var tabClass = item.className.indexOf('tab__link--active');

            if (tabClass >= 1) {
              var array = _toConsumableArray($tabsContents);
