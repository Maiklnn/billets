...
var sliderProjects = document.querySelector('.advantages-list-slider');
var mySwiper = new Swiper(sliderProjects, {
  slidesPerView: 1,
  speed: 1000,
  slidersPerView: 1,
  effect: "slide",
...
var sliderBook = document.querySelector('.book-slider');
var bookSwiper = new Swiper(sliderBook, {
  slidesPerView: 1,
  speed: 1000,
  slidersPerView: 1,
  effect: "slide",
...
var sliderPartition = document.querySelector('.partition-slider');
var partitionSwiper = new Swiper(sliderPartition, {
  slidesPerView: 1,
  speed: 1000,
  slidersPerView: 1,
  effect: "slide",
...
var slidersKeys = document.querySelectorAll('.sliders-keys');
slidersKeys.forEach(function (item) {
  new Swiper(item, {
    slidesPerView: 1,
    speed: 1000,
    slidersPerView: 1,
...
var sliderBottom = document.querySelector('.bottom-slider');
var mySwiper1 = new Swiper(sliderBottom, {
  spaceBetween: 10,
  // растояние
  autoplay: {
